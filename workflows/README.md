...
| [i2v 首帧锚定](#3-图生视频--首帧锚定锁脸) | 锁脸 / 画面续接 | — |
...
**文件**：[h3_w4a8_i2v_compat_api.json](h3_w4a8_i2v_compat_api.json)

需要一个首帧图（角色标准帧/已验收镜头抽帧），`Picture 1 is fully referenced` 锚定——脸一致率显著高于纯文生视频。仓库用默认首帧占位，导入后换成你自己的图。
